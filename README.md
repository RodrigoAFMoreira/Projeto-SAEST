...
- Integrar cards de conteúdos educativos com o banco de dados (tabela EPI).
- Completar a implementação de gráficos e analytics no dashboard.
- Continuar a transição para Supabase e finalizar a estilização com Tailwind CSS.
- Adicionar mais funcionalidades de gerenciamento de segurança, como relatórios e notificações.

## Contribuidores

- **Rodrigo**: Desenvolvimento principal, configuração de Vite + React, roteamento, estilização e funcionalidades de usuário.
- **Caroline**: Configuração inicial do Tailwind CSS.
